-- Allow contract intake responses to be either accepted or rejected
--
-- Previous RPC required accepted=true and blocked rejections.
-- This migration allows saving a response with accepted=false, while keeping
-- required fields for accepted contracts.
--
-- Date: 2026-02-23
